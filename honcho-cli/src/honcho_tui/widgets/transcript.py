...
class TranscriptPanel(Widget):
    ...
    def load_messages(self, session_id: str, messages: list[dict[str, object]]) -> None:
    ...
    def _write_message(self, log: RichLog, msg: dict[str, object]) -> None:
        peer_id = str(msg.get("peer_id", "unknown"))
