"""Task processor for queued top-down reasoning agent work."""
...
async def process_hypothesis_generation(
    ...
    logger.info(
        "Processing hypothesis generation for %s observing %s", observer, observed
    )
    ...
    logger.info(
        ...
        result.get("hypotheses_created", 0),
        result.get("premises_analyzed", 0),
    )
...
async def process_prediction_testing(
    ...
    logger.info(
        ...
        result.get("predictions_created", 0),
    )
...
async def process_induction(
    ...
    logger.info(
        ...
        result.get("inductions_created", 0),
        result.get("predictions_analyzed", 0),
    )
