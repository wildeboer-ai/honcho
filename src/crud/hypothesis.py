...
async def update_hypothesis(
    ...
    if hypothesis_update.unaccounted_premises_count is not None:
        hypothesis.unaccounted_premises_count = (
            hypothesis_update.unaccounted_premises_count
        )
        needs_update = True
    ...
    if hypothesis_update.superseded_by_id is not None:
        hypothesis.superseded_by_id = hypothesis_update.superseded_by_id
        needs_update = True

    if hypothesis_update.supersedes_ids is not None:
        hypothesis.supersedes_ids = hypothesis_update.supersedes_ids
        needs_update = True
