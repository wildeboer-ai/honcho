...
Example:
    ...
    for hyp in hypotheses:
        ...
        print(hyp["confidence"])  # Autocomplete available
    ```
"""
...
class Hypothesis(TypedDict, total=False):
    ...
    Attributes:
        ...
        superseded_by_id: ID of the hypothesis that superseded this one
        supersedes_ids: IDs of hypotheses this one supersedes
...
class Prediction(TypedDict, total=False):
    ...
    Attributes:
        ...
        status: Current status (untested, unfalsified, falsified)
    ...
    content: str
    status: str
    source_hypothesis_ids: list[str] | None
    is_blind: bool
    collection_id: str | None
    created_at: str
...
class FalsificationTrace(TypedDict, total=False):
    ...
    final_status: str
    search_count: int
    search_efficiency_score: float | None
    collection_id: str | None
    created_at: str
...
class InductionSources(TypedDict):
    ...
    Attributes:
        ...
        source_predictions: List of predictions that formed this pattern
        source_premises: List of observations that support the predictions
    """

    induction: Induction
    source_predictions: list[Prediction]
    source_premises: list[dict[str, Any]]  # Document type
